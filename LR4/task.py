    ...
    while curr_eps > eps:
        ...
        for i in range(1, Ny - 1):
            ...
            while j < (Nx - 4) * 3 + 2:
                ...
                right1[k] = mesh[i, k + 1] / tau + (mesh[i, k + 2] - 2 * mesh[i, k + 1] + mesh[i, k]) / hx ** 2 - f(xaxis[k + 1], yaxis[i])
                j += 3
                k += 1
        ...
        for i in range(1, Nx - 1):
            ...
            while j < (Ny - 4) * 3 + 2:
                ...
                right2[k] = mesh[k + 1, i] / tau + (mesh[k + 2, i] - 2 * mesh[k + 1, i] + mesh[k, i]) / hy ** 2 - f(xaxis[i], yaxis[k + 1])
                j += 3
                k += 1
